	...
	<body>
		...
		<?php 
			...
			while ($row1 = pg_fetch_row($result3)) {
				echo "<hr />";
				echo "<h3><a href =\"souscategorie.php?id=$row1[0]\"> $row1[0] - $row1[1] ($row1[2])</a> - <a href=\"souscategorie_nar.php?id=$row1[0]\">(liste pour narrateur)</a></h3>";
				/**
								...
								foreach ($gp2 as $k2b => $v2b) {
									...
									foreach ($g2 as $k3b => $v3b) {
										...
										if ($vocabulaireb_plus != "NULL") {
											" --- <b>".$vocabulaireb_plus."</b> : ".$traductionb_plus;
										}
									}
								}
							}
